...
import static org.github.javajake.ffxivcombat.dawntrail.math.akhmorning.FunctionsMathUtil.getAttackPowerStat;
import static org.github.javajake.ffxivcombat.dawntrail.math.akhmorning.FunctionsMathUtil.getHealingPowerStat;
import static org.github.javajake.ffxivcombat.dawntrail.math.akhmorning.FunctionsMathUtil.getSpeedStat;
...
public class Functions {
  ...
  public int fAP() {
    ...
    } else if (levelMod.level() <= LevelMod.DT_LEVEL) {
      switch (jobMod) {
        case PLD, WAR, DRK, GNB -> {
          return (int)
              // TODO: Undocumented; word of mouth
  ...
  /**
   * Documentation:
   * <a href="https://www.akhmorning.com/allagan-studies/stats/ten/#formulae">https://www.akhmorning.com/allagan-studies/stats/ten/#formulae</a>.
   *
  ...
  public int fTEN() {
    switch (jobMod) {
      case PLD, WAR, DRK, GNB -> {
        return (int)
            // f(TNC) = 1000 + ⌊ 112 × ( TNC - Level Lv, SUB )
            (1000.0 + (Math.floor(112.0 * (this.character.tenacity() - levelMod.sub())
                // / Level Lv, DIV ⌋
                / levelMod.div())));
      }
      default -> {
