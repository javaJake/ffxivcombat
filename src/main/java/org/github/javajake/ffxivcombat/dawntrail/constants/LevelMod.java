package org.github.javajake.ffxivcombat.dawntrail.constants;
...
public record LevelMod(
  ...
  public static final int DT_LEVEL = 100;
  ...
  public static final LevelMod[] BY_LEVEL = new LevelMod[]{
      ...
      new LevelMod(81, 10000, 345, 382, 1360, 2100, 0, 0),
      new LevelMod(82, 10000, 350, 384, 1420, 2200, 0, 0),
      new LevelMod(83, 10000, 355, 386, 1480, 2300, 0, 0),
      new LevelMod(84, 10000, 360, 388, 1540, 2400, 0, 0),
      new LevelMod(85, 10000, 365, 390, 1600, 2500, 0, 0),
      new LevelMod(86, 10000, 370, 392, 1660, 2600, 0, 0),
      new LevelMod(87, 10000, 375, 394, 1720, 2700, 0, 0),
      new LevelMod(88, 10000, 380, 396, 1780, 2800, 0, 0),
      new LevelMod(89, 10000, 385, 398, 1840, 2900, 0, 0),
      new LevelMod(90, 10000, 390, 400, 1900, 3000, 0, 0),
      new LevelMod(91, 10000, 395, 402, 1988, 3100, 0, 0),
      new LevelMod(92, 10000, 400, 404, 2076, 3200, 0, 0),
      new LevelMod(93, 10000, 405, 406, 2164, 3300, 0, 0),
      new LevelMod(94, 10000, 410, 408, 2252, 3400, 0, 0),
      new LevelMod(95, 10000, 415, 410, 2340, 3500, 0, 0),
      new LevelMod(96, 10000, 420, 412, 2428, 3600, 0, 0),
      new LevelMod(97, 10000, 425, 414, 2516, 3700, 0, 0),
      new LevelMod(98, 10000, 430, 416, 2604, 3800, 0, 0),
      new LevelMod(99, 10000, 435, 418, 2692, 3900, 0, 0),
      new LevelMod(100, 10000, 440, 420, 2780, 4000, 0, 0),
  };
}
