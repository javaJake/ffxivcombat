...
public class DamageAndHealing {
  ...
  public int getDamageOverTime(DamageAction action, double criticalHitRate, double directHitRate, double variance) {
    ...
    switch (action.type()) {
      case PHYSICAL -> {
        ...
        int damage2 = (int) (Math.floor(Math.floor(Math.floor(Math.floor(Math.floor(Math.floor(Math.floor(
      ...
      case MAGICAL -> {
        ...
        int damage1 = (int) (Math.floor(Math.floor(Math.floor(Math.floor(
            // D1 = ⌊ Potency × f(WD) ⌋ /100 ⌋ × f(ATK) ⌋ /100 ⌋
            action.potency() * functions.fWD()) / 100.0) * functions.fAP() / 100.0)
                // × f(SPD) ⌋ /1000 ⌋
                * functions.fSPD() / 1000.0));
        int damage2 = (int) (Math.floor(Math.floor(Math.floor(Math.floor(
  ...
  public int getAutoAttackDamage(double criticalHitRate, double directHitRate, double variance) {
    ...
    int damage2 = (int) (Math.floor(Math.floor(Math.floor(Math.floor(Math.floor(Math.floor(
        // D2 = ⌊ D1 × f(TNC) ⌋ /1000 ⌋ × f(SPD) ⌋ /1000 ⌋
        damage1 * functions.fTEN()) / 1000.0) * functions.fSPD()) / 1000.0)
