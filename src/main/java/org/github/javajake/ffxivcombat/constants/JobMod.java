...
public enum JobMod {
  ...
  JobMod(int id, int hp, int mp, int str, int vit, int dex, int intl, int mnd, int trait, MainStat mainStat) {
    this.id = id;
    this.hp = hp;
    this.mp = mp;
    this.str = str;
  ...
  public int mainStat() {
    ...
    throw new IllegalStateException("BUG: missing main stat logic: " + this.mainStat);
  }
